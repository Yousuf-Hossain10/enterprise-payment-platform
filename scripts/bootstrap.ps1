...
foreach ($db in @("identity", "wallet", "payment")) {
...
Write-Host "==> Bootstrap complete (namespaces, Postgres/RabbitMQ/Redis, Ingress, observability stack, and per-service databases)"
